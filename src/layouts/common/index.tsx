...
export class CommonLayout extends React.Component<any, any> {
  ...
  renderPageHeader() {
    ...
    return (
      <div className={styles.pageHeader}>
        <Breadcrumb className={styles.pageHeaderBreadcrumb} separator=">">
          {breadcrumb.map(item => {
            return (
        ...
        <div className={styles.pageHeaderDetail}>
    ...
    return (
      ...
      >
        <div className={styles.logo}>
          <a href="/">
            <img src="../../static/img/Aries.png" alt="logo" />
            <h1>Aries CI Platform</h1>
          </a>
        </div>
        <Menu theme="dark" selectedKeys={[activeSiderMenu]} mode="inline">
          {sidemenu.map(item => {
            return (
  ...
  render() {
    const { sidemenu, children, activeSiderMenu } = this.props;
    return (
      // vh: Viewport Height
      <Layout style={{ minHeight: "100vh" }}>
        ...
        <Layout>
          ...
          <Footer className={styles.footer}>
            Aries CI Plat1form ©2019 Created by Afauria
          </Footer>
        </Layout>
      </Layout>
    );
